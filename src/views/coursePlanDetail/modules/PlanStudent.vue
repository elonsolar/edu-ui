  ...
  >
    <a-card :bordered="false">
      ...
      <div class="table-operator">
        <a-button type="primary" icon="plus" @click="handleAdd">报名</a-button>
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          <template>
            ...
            <a @click="handleStop(record)">停课</a>
            </a-space>
          </template>
        </span>
      </s-table>
...
import { listCoursePlanStudent,stopCoursePlanStudent } from '@/api/coursePlan'
...
export default {
  ...
  data () {
    ...
    return {
      ...
      loadData: parameter => {
        ...
        return listCoursePlanStudent(newObj)
          .then(res => {
            return res
          })
      },
  ...
  methods: {
    ...
    handleStop(record){
      stopCoursePlanStudent({id:record.id}).then(res=>{
