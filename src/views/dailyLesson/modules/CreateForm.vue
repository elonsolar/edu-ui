        ...
        <a-row :gutter="16">
          ...
          <a-col span="12">
            <a-form-model-item label="开始时间" prop="cycleType">
              <a-time-picker style="width: 300px" :default-value="moment(this.form.startTime||'24:00', 'HH:mm')||null" @change="(m,s)=>handleTimeChange(s,'endTime')" format="HH:mm" />
            </a-form-model-item>
        </a-col>
        <a-col span="12">
        ...
        <a-col span="12">
          ...
          <a-col span="12">
            <a-form-model-item label="年级" prop="description">
              <a-input style="width: 100%" auto-size v-model="form.gradeName" />
            </a-form-model-item>
          </a-col>
      </a-row>
      <a-row :gutter="16">
        <a-col span="12">
          <a-form-model-item label="课时数" prop="description">
              <a-input style="width: 100%" auto-size v-model="form.lessonNum" />
            </a-form-model-item>
        </a-col>
        <a-col span="12">
          <a-form-model-item label="计划人数" prop="description">
              <a-input style="width: 100%" auto-size v-model="form.planNum" />
            </a-form-model-item>
        </a-col>
      </a-row>
    </a-form-model>
...
export default {
  ...
  methods:{
    ...
    handlePlanChange(value,node) {
      ...
      let cycleType=node.data.attrs.cycleType
